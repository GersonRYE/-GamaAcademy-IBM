...
public class DepartamentoController {
	...
	// injetando a interface pois ela ja esta conectada com a logica do service, assim possibilitando a injeção com a logica
	@Autowired
	...
	//ResponseEntity - ele me retorna uma resposta http
